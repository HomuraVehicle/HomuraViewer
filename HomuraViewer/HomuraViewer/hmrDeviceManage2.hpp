#ifndef HMR_DEVICEMANAGE2_INC
#define HMR_DEVICEMANAGE2_INC 100
#
/*==========hmrDeviceManage============
...
//		typedef cMessage::iMessageStrategy base_type;
	class cDevMngMsgAgent2:public itfMessageAgent{
	public:
	...
	public:
		cDevMngMsgAgent2():SetSleepFlag(false),ReadySleepFlag(false),ExeSleepFlag(false),SetRoamFlag(false),ReadyRoamFlag(false),
