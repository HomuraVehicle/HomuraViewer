#ifndef HMR_VIEWER_VIEW_DXINFORMATIRON_INC
#define HMR_VIEWER_VIEW_DXINFORMATIRON_INC 100
#
#include<chrono>
#include"hmLibVer.hpp"
#include<hmLib_v2/dxObject.hpp>
#include<HomuraViewer/GPS/DxGPSKashmir.hpp>
#include<HomuraViewer/Controller/PadStatus.hpp>
#include<HomuraViewer/Battery/DxBattery.hpp>
	...
	namespace viewer{
		namespace view{
			class dxosInformation :public dxReObject, public hmoBox{
				using this_adc_data_t = fulladc::data_t<8>;
			public:
				gps::dxosGPSKashmirBut GPSKashmirBut;
				controller::dxoPadStatusBut PadStatusBut;
