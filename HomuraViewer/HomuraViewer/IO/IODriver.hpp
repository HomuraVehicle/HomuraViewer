#ifndef HMR_VIEWER_IO_IODRIVER_INC
#define HMR_VIEWER_IO_IODRIVER_INC 106
#
/*===hmrIO===
	...
	namespace viewer{
		namespace io{
			...
			public:
				...
				cFdxIODriver(VMCCreater& vmcc_) :pVMC(vmcc_()), pGate(nullptr){
			...
			public:
				template<class VMCCreater>
				cFHdxIODriver(VMCCreater& vmcc_) :pVMC(vmcc_()), pGate(nullptr){
