#ifndef HMR_VIEWER_DEVMNG_DEVICEMANAGEMSGAGENT_INC
#define HMR_VIEWER_DEVMNG_DEVICEMANAGEMSGAGENT_INC 100
#
/*==========hmrDeviceManage============
...
namespace hmr{
	namespace viewer{
		namespace devmng{
			...
			public:
				cMsgAgent() :SetSleepFlag(false), ReadySleepFlag(false), ExeSleepFlag(false), SetRoamFlag(false), ReadyRoamFlag(false),
