#ifndef HMR_VIEWER_GPS_DXMUI_INC
#define HMR_VIEWER_GPS_DXMUI_INC 101
#
/*===hmrDxGPSMUI===
...
namespace hmr{
	namespace viewer{
		namespace gps{
			...
			public:
				//hmLib::inquiries::inquiry<data> inquiry_getGPSData;
				data GPSData;
				...
				dxoBut SetGPSNumBut;
			public:
				dxosMUI() :dxosBUI("GPS", 30, 105), IsDataModeMUIBut(this){}
			public:
			...
			private:
				...
				void setData(clock::time_point time_, const data& GPSData_){
					//Time = time_;
					GPSData = GPSData_;
				}
				...
				// slot 
			public:
				void slot_getData(boost::signals2::signal<void(const data&, clock::time_point)>& Signal_){
					SignalConnections(hmLib::signals::connect(Signal_, [&](const data& data_, clock::time_point time_)->void{this->setData(time_, data_); }));
				}
