...
namespace hmr{
	...
	void connect_Keyboard(cThermoMsgAgent& Thermo_,cDxKeyboard& Keyboard_){
		Thermo_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::T)));
	}
#endif
...
//		Agent_.slot_setAutoTakePicture(MUI_.AutoTakePictureMUIBut.Signal);
		...
		Agent_.slot_setTakePicture(Keyboard_.signal(hmr::is_key_pushed(KEY::S)));
...
//		Agent_.slot_setAutoPowerReset(MUI_.AutoPowerResetMUIBut.Signal);
		...
		Agent_.slot_setCommandReset(Keyboard_.signal(hmr::is_key_pushed(KEY::C)));

		Agent_.slot_setPowerReset(Keyboard_.signal(hmr::is_key_pushed(KEY::P)));
...
//		Agent_.slot_setMiniPacketMode(MUI_.MiniPacketModeMUIBut.Signal);
	...
	void connect_Keyboard(cCO2MsgAgent& Agent_,cDxKeyboard& Keyboard_){
		Agent_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::C)));
		Agent_.slot_setPumpPW(Keyboard_.signal(hmr::is_key_pushed(KEY::C)));
		Agent_.slot_setSensorPW(Keyboard_.signal(hmr::is_key_pushed(KEY::C)));
	}
#endif

#if defined(HMR_ACCELE_INC)
	void connect_Keyboard(cAcceleMsgAgent& Agent_,cDxKeyboard& Keyboard_){
		Agent_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::A)));
		Agent_.slot_setCorrection(Keyboard_.signal(hmr::is_key_pushed(KEY::A)));
	}
#endif
	...
	void connect_Keyboard(cCompassMsgAgent& Agent_,cDxKeyboard& Keyboard_){
		Agent_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::C)));
		Agent_.slot_setCorrectionMode(Keyboard_.signal(hmr::is_key_pushed(KEY::A)));
	}
#endif

#if defined(HMR_GYRO_INC)
	void connect_Keyboard(cGyroMsgAgent& Agent_,cDxKeyboard& Keyboard_){
		Agent_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::G)));
		Agent_.slot_setCorrectionFlag(Keyboard_.signal(hmr::is_key_pushed(KEY::G)));
	}
#endif
	...
	void connect_Keyboard(cInfraRedMsgAgent& Agent_,cDxKeyboard& Keyboard_){
		Agent_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::I)));
	}
#endif

#if defined(HMR_BATTERY_INC)
	template<unsigned int Num_>
	void connect_Keyboard(cBatteryMsgAgent<Num_>& Agent_,cDxKeyboard& Keyboard_){
		Agent_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::B)));
	}
#endif

#if defined(HMR_HUMID_INC)
	void connect_Keyboard(cHumidMsgAgent& Agent_,cDxKeyboard& Keyboard_){
		Agent_.slot_setDataMode(Keyboard_.signal(hmr::is_key_pushed(KEY::H)));
	}
#endif
