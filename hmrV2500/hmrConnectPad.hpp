...
#define PAD_SHIFT PAD::But7
	...
	void connect_Pad(cThermoMsgAgent& Thermo_,cDxPad1& Pad_){
		Thermo_.slot_setDataMode(Pad_.signal(hmr::is_pad1_pushed(SensorDataModeBut)));

	}
#endif
#if defined(HMR_SHT75_INC)
	void connect_Pad(cSHT75MsgAgent& SHT75MA_,cDxPad1& Pad_){
		SHT75MA_.slot_setDataMode(Pad_.signal(hmr::is_pad1_pushed(SensorDataModeBut)));

	}
#endif
#if defined(HMR_SPRITE_INC)
	void connect_Pad(cSpriteMsgAgent& Agent_,cDxPad1& Pad_){
		Agent_.slot_setTakePictureLarge(Pad_.signal(hmr::is_pad1_pushed(LargeTakePicBut)));

		Agent_.slot_setAutoTakePicture(Pad_.signal(hmr::is_pad1_pushed(AutoTakePicModeBut)));
	}
#endif

#if defined(HMR_CO2_INC)
	void connect_Pad(cCO2MsgAgent& Agent_,cDxPad1& Pad_){
		Agent_.slot_setDataMode(Pad_.signal(hmr::is_pad1_pushed(SensorDataModeBut)));
		Agent_.slot_setPumpPW(Pad_.signal(hmr::is_pad1_pushed(SensorDataModeBut)));
		Agent_.slot_setSensorPW(Pad_.signal(hmr::is_pad1_pushed(SensorDataModeBut)));
	}
#endif

#if defined(HMR_ACCELE_INC)
	void connect_Pad(cAcceleMsgAgent& Agent_,cDxPad1& Pad_){
		Agent_.slot_setDataMode(Pad_.signal(hmr::is_pad1_pushed(CockpitDataModeBut)));
//		Agent_.slot_setCorrection(Pad_.signal(hmr::is_pad1_pushed(PAD::But1)));
	}
#endif
	...
	void connect_Pad(cCompassMsgAgent& Agent_,cDxPad1& Pad_){
		Agent_.slot_setDataMode(Pad_.signal(hmr::is_pad1_pushed(CockpitDataModeBut)));
//		Agent_.slot_setCorrectionMode(Pad_.signal(hmr::is_pad1_pushed(PAD::But1)));
	}
#endif
	...
	void connect_Pad(cGyroMsgAgent& Agent_,cDxPad1& Pad_){
		Agent_.slot_setDataMode(Pad_.signal(hmr::is_pad1_pushed(CockpitDataModeBut)));
//		Agent_.slot_setCorrectionFlag(Pad_.signal(hmr::is_pad1_pushed(PAD::But1)));
	}
#endif
	...
	void connect_Pad(cBatteryMsgAgent<Num_>& Agent_,cDxPad1& Pad_){
		Agent_.slot_setDataMode(Pad_.signal(hmr::is_pad1_pushed(SensorDataModeBut)));
	}
#endif
	...
	void connect_Pad(cMotorMsgAgent& Agent_,cDxPad1& Pad_){
		...
		Agent_.slot_setBrakeLON(Pad_.signal(hmr::is_pad1_pushed(PAD::But11)));
		Agent_.slot_setBrakeLOFF(Pad_.signal(hmr::is_pad1_pulled(PAD::But11)));
		
		Agent_.slot_setStickR(Pad_.signal_RStick);
		Agent_.slot_setBrakeRON(Pad_.signal(hmr::is_pad1_pushed(PAD::But12)));
		Agent_.slot_setBrakeROFF(Pad_.signal(hmr::is_pad1_pulled(PAD::But12)));

		Agent_.slot_setBackModeON(Pad_.signal(hmr::is_pad1_pushed(PAD::But9)));
		Agent_.slot_setBackModeOFF(Pad_.signal(hmr::is_pad1_pushed(PAD::But10)));
	}
#endif
/*
